        ...
        <Container>
          ...
          <div className="mt-10 space-y-6 leading-relaxed">
            <LegalSection title="1. Introduction">
              <p>
                Kabir Dohe Hub (&ldquo;we,&rdquo; &ldquo;our,&rdquo; or &ldquo;us&rdquo;) is committed to protecting
            ...
            <LegalSection title="2. Information We Collect">
              ...
              <ul className="mt-2 list-disc space-y-1 pl-6">
                <li>
                  <strong>Usage Data:</strong> Anonymous page views and interaction data collected via cookies or
                  similar technologies to understand how our site is used.
                </li>
                <li>
                  <strong>Device Information:</strong> Browser type, operating system, and referring URLs — standard
                  data sent by your browser.
                </li>
              </ul>
            </LegalSection>
            ...
            <LegalSection title="5. Third-Party Services">
              <p>
                ...
                aggregate data with analytics providers to understand site usage. These providers are contractually
